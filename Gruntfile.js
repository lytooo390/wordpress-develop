/**
 * Gruntfile configuration for WordPress development.
 *
 * This file defines tasks and configurations for building, testing, and maintaining
 * the WordPress codebase. It includes tasks for JavaScript, CSS, PHP, and other assets.
 *
 * @file Gruntfile.js
 * @description This file is used to configure Grunt tasks for WordPress development.
 * @requires path
 * @requires fs
 * @requires glob
 * @requires assert
 ...
 * @requires sass
 * @requires install-changed
 * @requires json2php
 * @requires grunt-legacy-util
 * @requires webpack.config
 */
/* jshint node:true */
/* jshint esversion: 6 */
/* globals Set */
				...
				files: [
					{
						...
						[WORKING_DIR + 'wp-includes/js/core-js.js']: ['./node_modules/core-js/index.js'],
						[WORKING_DIR + 'wp-includes/js/core-js.min.js']: ['./node_modules/core-js/minified.js'],
					}
				]
			},
			'vendor-js': {
